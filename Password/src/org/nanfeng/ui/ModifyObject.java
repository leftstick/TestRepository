...
public class ModifyObject extends BaseDialog {
	...
	protected void initContents(Composite parent) {
		...
		Label text_objectName = new Label(main, SWT.LEFT | SWT.BORDER);
		text_objectName.setBackground(new Color(null, 255, 255, 255));
		...
		obj = getData("object", ObjectInfo.class);
